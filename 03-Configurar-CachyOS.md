...
- Vai ao **Menu Iniciar** e procura por **Carteira KDE** (**Wallet**), e faz estes 2 passos **pela ordem descrita**:
  ...
  2. **Desativa** "Sub-Sistema" (em cima), clica em **Aplicar**
- Fecha a janela. O KWallet já não te chateia mais.

## 3. Configurar o Dolphin (Gestor de Ficheiros)
O **Dolphin** é o gestor de ficheiros do KDE Plasma, semelhante ao **Explorador de Ficheiros** no Windows ou **Finder** no MacOS. Vamos fazer uma ligeira configuração para melhorar a experiência.
...
## 4. Outras Configurações e Informações Úteis
- Vai ao **Menu Iniciar** e procura por **Tema Global**. Escolhe o que preferires, e **Ativa** as opções **Configuração da Aparência** e **Disposição da Área de Trabalho e das Janelas**.
...
- Vai ao **Menu Iniciar** e procura **Configuração do Sistema**, isto é semelhante ao **Painel de Controlo/Definições** do Windows. Aqui podes modificar as definições de Teclado, Rato, Som, Energia, etc ao teu gosto. Investiga e testa à vontade.
...
## 5. Resolução de Problemas / Troubleshoot

### 5.1 Snapshots / BTRFS Assistant
...
### 5.2 Aceder ao Disco Windows (NTFS)
...
### 5.3 Mostrar a Opção do Windows no Menu de Arranque (GRUB)
