...
## 🎨 Tema Global
- Vai ao **Menu Iniciar** e procura por **Tema Global**.
- Seleciona um dos temas disponíveis, ou clica em **Get New** para descarregares outros.
- Certifica-te que **Ativas** as opções **Configuração da Aparência** e **Disposição da Área de Trabalho e das Janelas**.
- Pessoalmente gosto do **Brisa ao Anoitecer / Breeze Twilight**.

## 🐬 Configurar o Dolphin (Gestor de Ficheiros)
...
## ⚙️ Outras Configurações e Informações Úteis
