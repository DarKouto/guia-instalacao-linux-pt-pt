...
- A pasta dos jogos instalados pela Steam está em: `~/.local/share/Steam/steamapps/common`
- Os Saves/Configs que estariam na pasta **AppData** do Windows estão em: `~/.local/share/Steam/steamapps/compatdata/ID-NUMÉRICO-DO-JOGO/pfx/drive_c/users/steamuser/`
...
- Na **Versão** escolhes:
  - GE-Proton-11-*nr-mais-recente*, e clicas **Instalar**, e esperas que termine.
...
- Ao instalares uma nova versão do **GE-Proton-11**, podes remover a antiga. Exemplo: se instalares o **GE-Proton11-3** podes remover o GE-Proton11-2 e inferiores.
...
<img src="https://github.com/DarKouto/guia-instalacao-linux-pt-pt/blob/main/imagens/lutris.jpg" width=700>
