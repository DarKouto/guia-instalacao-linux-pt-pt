...
Para instalar aplicações vamos usar o **Shelly** que é um ambiente gráfico que nos permite pesquisar nos repositórios. Também existe a possiblidade de usar a **Konsole**, com um comando do género: ```sudo pacman -S audacious```. No entanto o **Shelly** é mais simples e intuitivo.
