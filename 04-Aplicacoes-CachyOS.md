...
```
Com este comando instalámos as seguintes aplicações:
- **Google Chrome**: o famoso browser da Google. **NÃO RECOMENDO** ninguém usar este devorador de RAM e telemetria. Mas sei que muita gente tem lá todas as suas contas e os dados, e não quer estar a ter o trabalho de migrar para outro browser, portanto cá fica.
